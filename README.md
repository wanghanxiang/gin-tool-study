...
|        [errors](https://github.com/emperror/errors)         | [下拉更换为标准库的错误包和github.com/pkg/errors。提供各种错误处理原语。](http://xn--github-hp7iqmm6yfkd5wfcw3blplh5byxx19dut5f3tyesnsb.com/pkg/errors。提供各种错误处理原语。) |
...
|            [sftp](https://github.com/pkg/sftp)             | 程序包sftp实现SSH文件传输协议，如https://filezilla-project.org/specs/draft-ietf-secsh-filexfer-02.txt |
